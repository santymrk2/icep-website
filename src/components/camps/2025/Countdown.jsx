  ...
  return (
    <section className="py-20 my-20">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="flex flex-row md:flex-row justify-center items-center gap-4 md:gap-8">
          <div className="text-center">
            <div className="flex flex-col justify-center items-center bg-gray-100 rounded-lg sm:p-6 size-18 sm:size-28">
              <div id="days" className="text-4xl sm:text-6xl font-bold text-green-800 font-rari">{timeLeft.days}</div>
            </div>
          ...
          <div className="text-center">
            <div className="flex flex-col justify-center items-center bg-gray-100 rounded-lg sm:p-6 size-18 sm:size-28">
              <div id="hours" className="text-4xl sm:text-6xl font-bold text-green-800 font-rari">{timeLeft.hours}</div>
            </div>
          ...
          <div className="text-center">
            <div className="flex flex-col justify-center items-center bg-gray-100 rounded-lg sm:p-6 size-18 sm:size-28">
              <div id="seconds" className="text-4xl sm:text-6xl font-bold text-green-800 font-rari">{timeLeft.minutes}</div>
            </div>
        ...
        <div className="text-center">
          <div className="flex flex-col justify-center items-center bg-gray-100 rounded-lg sm:p-6 size-18 sm:size-28">
            <div id="seconds" className="text-4xl sm:text-6xl font-bold text-green-800 font-rari">{timeLeft.seconds}</div>
          </div>
