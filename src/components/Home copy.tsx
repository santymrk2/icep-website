    ...
    <main ref={containerRef}>
      ...
      >
        <div className="flex flex-col justify-center items-center h-full w-full">
          <motion.h1
            className="text-5xl md:text-7xl font-sans font-bold text-center m-0 p-0"
            style={{
              scale: heroScale,
              y: heroYMove,
              opacity: heroOpacity,
        ...
        <div className="relative h-screen sm:h-full">
          ...
          >
            <div className="text-center">
              <motion.h2
                className="text-5xl sm:text-5xl md:text-5xl font-sans font-bold text-center sm:text-right"
      ...
      <section ref={imgRefs[1]} className="w-full h-full sm:h-screen overflow-hidden">
        <div className="relative h-screen sm:h-full">
          ...
          >
            <div className="text-center">
              <motion.h2
                className="text-5xl sm:text-5xl md:text-5xl font-sans font-bold text-center sm:text-left"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.7 }}
                viewport={{ once: true }}
