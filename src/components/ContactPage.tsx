...
const ContactPage: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="bg-neutral-950 transition-colors duration-500 overflow-x-hidden">
      
      {/* 1. HERO */}
      <section className="relative min-h-[60vh] flex flex-col justify-center items-center text-center px-6 pt-32 pb-20">
         <div className="max-w-4xl">
            <p className="hero-reveal opacity-0 translate-y-6 text-sm font-sans uppercase tracking-[0.4em] text-neutral-400 mb-6">
               Estamos para escucharte
            </p>
            <h1 className="hero-reveal opacity-0 translate-y-6 text-4xl sm:text-6xl md:text-7xl font-sans font-extrabold tracking-tight text-white leading-[1.1]">
      ...
      <section className="reveal-section py-24 px-6 sm:px-12 lg:px-24">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
           ...
           <a href="mailto:info@icepilar.org" className="group p-10 rounded-[2.5rem] bg-neutral-900 border border-white/10 hover:border-white transition-all text-center">
              <div className="size-16 rounded-2xl bg-white/5 flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform duration-500">
                 <svg className="size-8 fill-white" viewBox="0 0 24 24">
                    <path d="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67z" />
                    <path d="M22.5 6.908V6.75a3 3 0 00-3-3h-15a3 3 0 00-3 3v.158l9.714 5.978a1.5 1.5 0 001.572 0L22.5 6.908z" />
                 </svg>
              </div>
              <h3 className="text-xl font-bold text-white mb-2 font-sans">Email</h3>
              <p className="text-neutral-400 text-sm mb-6 font-sans">Consultas generales y ministerios.</p>
              <span className="text-sm font-bold text-white border-b-2 border-neutral-800 pb-1 group-hover:border-white transition-all font-sans">info@icepilar.org</span>
           </a>

           <a href="https://instagram.com/ice_pilar" className="group p-10 rounded-[2.5rem] bg-neutral-900 border border-white/10 hover:border-white transition-all text-center">
              <div className="size-16 rounded-2xl bg-white/5 flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform duration-500">
                 <svg className="size-8 fill-white" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-bold text-white mb-2 font-sans">Instagram</h3>
              <p className="text-neutral-400 text-sm mb-6 font-sans">Día a día y comunidad.</p>
              <span className="text-sm font-bold text-white border-b-2 border-neutral-800 pb-1 group-hover:border-white transition-all font-sans">@ice_pilar</span>
           </a>

           <a href="https://facebook.com/icepilar" className="group p-10 rounded-[2.5rem] bg-neutral-900 border border-white/10 hover:border-white transition-all text-center">
              <div className="size-16 rounded-2xl bg-white/5 flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform duration-500">
                 <svg className="size-8 fill-white" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-bold text-white mb-2 font-sans">Facebook</h3>
              <p className="text-neutral-400 text-sm mb-6 font-sans">Novedades y recursos.</p>
              <span className="text-sm font-bold text-white border-b-2 border-neutral-800 pb-1 group-hover:border-white transition-all font-sans">@icepilar</span>
           </a>
        </div>
      </section>

      {/* 3. VISIT SECTION */}
      <section className="reveal-section py-32 px-6 sm:px-12 lg:px-24 bg-neutral-900">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl font-extrabold text-white leading-tight font-sans">Vení a compartir una reunión con nosotros</h2>
            ...
            <div className="py-4">
               ...
               <p className="text-2xl font-bold text-white font-sans">Domingos, 10:00 hs</p>
            </div>
            <a href="https://maps.app.goo.gl/TEdvqX2pNJz34sfn8" className="inline-flex items-center gap-3 rounded-full border border-white px-8 py-3 font-bold text-white hover:bg-white hover:text-neutral-900 transition-all font-sans">
               Ver ubicación en Maps
            </a>
          </div>
          <div className="h-80 sm:h-[450px] overflow-hidden rounded-[2.5rem] shadow-2xl border-4 border-neutral-800">
      ...
      <section className="reveal-section py-32 px-6 sm:px-12 lg:px-24">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-5xl font-extrabold text-white mb-8 font-sans">Sumate a la comunidad digital</h2>
          ...
          <a 
            ...
            className="group relative block aspect-video w-full rounded-[2.5rem] overflow-hidden shadow-2xl border border-neutral-800 bg-neutral-900 transition-transform duration-500 hover:scale-[1.02]"
          >
