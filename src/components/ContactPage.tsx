...
const ContactPage: React.FC = () => {
  const highlightCards = [
    ...
    },
    {
      ...
      icon: (
        <svg className="size-10 fill-white" viewBox="0 0 24 24">
  ...
  const socialCards = [
    {
      ...
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          className="size-12 fill-white group-hover:fill-gray-200 transition-colors"
        >
          <path d="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67z" />
          <path d="M22.5 6.908V6.75a3 3 0 00-3-3h-15a3 3 0 00-3 3v.158l9.714 5.978a1.5 1.5 0 001.572 0L22.5 6.908z" />
        </svg>
  ...
  return (
    <>
      {/* Hero Section */}
      <motion.section
        className="min-h-[calc(100vh-5rem)] w-full flex flex-col justify-center items-center gap-8 px-4 text-center sm:px-6"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8 }}
      >
        <motion.h1
          className="text-4xl sm:text-5xl md:text-6xl font-bold font-sans leading-tight max-w-3xl mx-auto"
        ...
        <motion.p
          className="max-w-2xl text-base sm:text-lg text-white/80 font-sans"
        ...
        <motion.p
          className="text-white/60 font-sans text-sm sm:text-base"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      <div className="space-y-20 sm:space-y-24">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {highlightCards.map((card, index) => (
              <motion.a
                key={card.title}
                href={card.href}
                className="group rounded-3xl border border-white/15 px-6 py-7 sm:px-7 sm:py-8 transition hover:border-white/35 hover:bg-white/[0.05]"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex flex-col md:flex-row sm:gap-10 lg:gap-24 m-2 md:items-center max-w-screen-lg mx-auto">
            <motion.div
              className="flex flex-col justify-center items-start max-w-7xl mx-auto order-2 md:order-1 text-left md:text-right px-4"
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, delay: 0.2 }}
              viewport={{ once: true }}
            >
              <div className="text-left mb-10 mx-4">
                <motion.h1
                ...
                <motion.p
                  className="text-white/70 font-sans mt-3 md:text-right"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  {socialCards.map((item, index) => (
                    <motion.a
                      key={item.label}
                      href={item.href}
                      className="group flex flex-col items-start justify-between rounded-2xl border border-white/15 p-6 transition hover:border-white/30 hover:bg-white/[0.05]"
                    ...
                    >
                      ...
                      <span className="mt-6 inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-white/50 transition-colors group-hover:text-white/80">
                        Escribir
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
        ...
        >
          <div className="flex flex-col md:flex-row gap-6 lg:gap-24 m-2 md:items-center max-w-screen mx-auto">
            <motion.div
              className="flex flex-col justify-center items-start max-w-8xl mx-auto order-2 md:order-1 text-left md:text-right px-4"
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, delay: 0.2 }}
              viewport={{ once: true }}
            >
              <div className="text-left mb-10 mx-4">
                ...
                <p className="text-white/70 font-sans mt-3 md:text-right">
                ...
                <a href="https://maps.app.goo.gl/TEdvqX2pNJz34sfn8">
                  <div className="flex flex-row gap-4 justify-center items-center">
                    <div className="order-2 md:order-1">
                      ...
                      <p className="text-white/70 font-sans text-left md:text-right">
                        Av. Honorio Pueyrredón 2775, <br />
                        Pilar, Buenos Aires
                      </p>
                      <p className="mt-2 text-xs uppercase tracking-[0.2em] text-white/40 md:text-right">
          ...
          <div className="flex flex-col md:flex-row gap-8 sm:gap-10 lg:gap-24 m-2 md:items-center max-w-screen-lg mx-auto">
            ...
            >
              <div className="text-left mb-10 mx-4">
                ...
                <motion.p
                  className="text-white/70 mt-3 font-sans"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.6 }}
                  viewport={{ once: true }}
              ...
              >
                <a
                  href="https://www.youtube.com/@icepilar"
                  className="inline-flex items-center gap-3 rounded-full bg-white text-slate-900 px-5 py-3 text-sm font-semibold shadow-lg shadow-slate-900/30 transition hover:shadow-slate-900/40"
                >
