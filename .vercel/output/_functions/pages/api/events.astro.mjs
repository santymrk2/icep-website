...
import { c as createInvalidVariablesError, g as getEnv$1, s as setOnSetGetEnv } from '../../chunks/runtime_C1t4Lrlg.mjs';
export { renderers } from '../../renderers.mjs';

const schema = {"NOTION_API_KEY":{"context":"server","access":"secret","type":"string"},"DATABASE_ID":{"context":"server","access":"public","type":"string"},"GOOGLE_API_KEY":{"context":"server","access":"secret","type":"string"}};
...
const getPages = async () => {
  ...
  try {
    ...
    if (error.code === "unauthorized") {
      console.log("Error: No tienes acceso al recurso especificado. Revisa tus credenciales y permisos.");
    } else {
